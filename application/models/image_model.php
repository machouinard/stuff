...
class Image_model extends CI_Model{
    ...
    public function get_album(){
        ...
        $this->db->select('image_url, thumb_url, formatted_address');
        ...
        foreach($result as $image){
            ...
            $line = "<a href='$image->image_url' data-lightbox=\"image-1\"><img src='$image->thumb_url' /></a>";
            $line .= '<p>' . $image->formatted_address . '</p>';
