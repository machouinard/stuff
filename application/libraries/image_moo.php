...
//		    if( $this->width > $this->height ) { could calc wronf - Cole Thorsen swapped to his suggestion
	...
	public function center_crop($w, $h) {
        ...
        public function fix_rotation(){

// 		echo 'file location from fix_rotation function line 1169: '.$image;



		$exif = exif_read_data($this->temp_image);
