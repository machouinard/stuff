...
if(!$this->ion_auth->is_group('library') || $this->ion_auth->is_admin()){
...
<div id="container" class="container_16">
	<header id="header" class="grid_16">
            ...
            if(isset($histo)){
                echo "<div id='histo' class='grid_3 pull_4'>".$histo."</div>";
            }
            if(isset($logo)){
                echo '<div class="grid_2 pull_14">
                <img src="'.$logo.'"/>
            </div>';
            }
            ?>
...
<div class="clear"></div>';
	...
	<footer id="footer" class="grid_14 push_1">
            <?php
            if($this->ion_auth->logged_in()){
