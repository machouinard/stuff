...
class Auth extends Controller {
	...
	function index()
	{
		...
		elseif (!$this->ion_auth->is_admin())
		{
			...
			$data = array(
                            'title' => 'Admin Only',
                            'content' => 'result',
                            'msg' => 'The page you were trying to view is Admin Only',
                            'error' => 1,
	...
	function login()
	{
                //echo 'Flashdata: '.$this->session->flashdata('url').  "<br />\r\n";
			...
			$this->data['password'] = array('name' => 'password',
				...
				'type' => 'password',
                        ...
                        $data = array(
                          'title' => 'login',
                            'page_title' => 'login',
                            'msg' => 'Ya cahn only get theyah, from heeah',
                            'content' => 'auth/login',
                            'logo' => '/images/graphics/login2.png',
                            'data' => $this->data,
                        );
			...
			//render
                        $data = array(
                          ...
                          'content' => 'auth/change_password',
                            'data' => $this->data,
                            'page_title' => '<span class="mini_text">change your password here</span>',
                            'logo' => '/images/graphics/login1.png',
                            'msg' => 'you\'ll have to log back in after this',
                        );
                        $this->load->view('page', $data);
//			$this->load->view('auth/change_password', $this->data);
	...
	function forgot_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$data = array(
                            'title' => 'Forgot Your Password, eh?',
                          'content' => 'auth/forgot_password',
                            'data' => $this->data,
                            'page_title' => 'Reset Password',
                            'msg' => '<span class="mini_text">After submitting this form we\'ll email you a link to reset your password.</span>',
                            'logo' => '/images/graphics/login2.png',
                        );
                        $this->load->view('page_guest', $data);
        ...
        function create_account()
	{
		...
		if ($this->form_validation->run() == true && $this->ion_auth->register($username, $password, $email, $additional_data))
		{ //check to see if we are creating the user
			//redirect them back to the welcome page
			...
			$this->data['password_confirm'] = array('name' => 'password_confirm',
				...
				'value' => $this->form_validation->set_value('password_confirm'),
                        ...
                        $data = array(
                          ...
                          'content' => 'auth/create_account',
                            'page_title' => 'create an account',
                            'msg' => 'You\'ll receive an email shortly with an activation link',
                            'logo' => '/images/graphics/email2.png',
                            'data' => $this->data,
                        );
                        $this->load->view('page_guest', $data);
//			$this->load->view('auth/create_user', $this->data);
